...
export default function InterviewSession({question,questionNumber,totalQuestions,jdAnalysis,onEvaluationComplete,}) {
...
function EvaluationResult({ evaluation, mode }) {
